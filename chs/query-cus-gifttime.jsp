...
<%@page import="com.kunshi.interfacef.vosweb.GetWebGiftTimeResponse"%>
...
<%
  ...
  GetWebGiftTimeResponse webResponse = new GetWebGiftTimeResponse();
  ...
  webResponse = (GetWebGiftTimeResponse) MGCConfig.listenerWebServer().sendRequestSyn(WebBodyId.VOS_WEB_GETWEBINFOCURRENTGIFTTIME_REQ,
      webQuery, MGCAPIPublicValue.FM_WEB_TIMEOUT);
  if (webResponse == null) {
    webResponse = new GetWebGiftTimeResponse();
