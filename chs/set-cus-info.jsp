...
<%
  ...
  WebSetCustomer requestVos = (WebSetCustomer) JsonUtil.fromJson(request.getReader(), WebSetCustomer.class);
  if (requestVos == null) {
  ...
  responseVos = (ResponseCommon) MGCConfig.listenerEquipment().sendRequestSyn(
      WebBodyId.VOS_WEB_SETINFOCUSTOMER_REQ, JsonUtil.toJson(requestVos), responseVos, MGCAPIPublicValue.FM_WEB_TIMEOUT);
  if (responseVos == null) {
