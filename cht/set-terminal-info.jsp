...
<%
  ...
  WebSetPhone requestVos = (WebSetPhone) JsonUtil.fromJson(request.getReader(), WebSetPhone.class);
  if (requestVos == null) {
  ...
  responseVos = (ResponseCommon) MGCConfig.listenerEquipment().sendRequestSyn(
      WebBodyId.VOS_WEB_SETINFOPHONE_REQ, JsonUtil.toJson(requestVos), responseVos, MGCAPIPublicValue.FM_WEB_TIMEOUT);
  if (responseVos == null) {
