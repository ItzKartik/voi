...
<%@page import="com.kunshi.interfacef.vosweb.GetWebCurrentSuiteResponse"%>
...
<%
  ...
  GetWebCurrentSuiteResponse webResponse = new GetWebCurrentSuiteResponse();
  ...
  webResponse = (GetWebCurrentSuiteResponse) MGCConfig.listenerWebServer().sendRequestSyn(WebBodyId.VOS_WEB_GETWEBINFOCURRENTSUITE_REQ, webQuery, MGCAPIPublicValue.FM_WEB_TIMEOUT);
  if (webResponse == null) {
    webResponse = new GetWebCurrentSuiteResponse();
