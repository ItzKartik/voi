...
<%
  ...
  try {
    GetMobileArea requestVos = (GetMobileArea)JsonUtil.fromJson(request.getReader(), GetMobileArea.class);
    if (requestVos == null) {
      return;
    }
    GetMobileAreaResponse responseVos = new GetMobileAreaResponse();
    responseVos = (GetMobileAreaResponse) MGCConfig.listenerWebServer().sendRequestJsonSyn(
	        		ExternalBodyId.GET_MOBILE_AREA, requestVos, MGCAPIPublicValue.FM_WEB_TIMEOUT, GetMobileAreaResponse.class);
    if (responseVos == null) {
      responseVos = new GetMobileAreaResponse();
